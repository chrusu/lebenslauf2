<!--<template>
    <div>
      ...
      <div class="portfolio-image"><img :src="portfolio.image" :alt="portfolio.name"></div>
      <div class="portfolio-name" v-html="portfolio.name">{{portfolio.name}}</div>
      <div class="portfolio-content" v-html="portfolio.html">{{portfolio.html}}</div> 
    </div>
</template>-->
